...
#include "GLFW/glfw3.h" // temp: should not be included here
#include "glad/glad.h"
...
namespace Glue
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMP: Subject of changes - will use Glue key mappings
		...
		GLUE_CORE_TRACE("ImGuiLayer intialized!");
	}
	...
	void ImGuiLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(GLUE_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
